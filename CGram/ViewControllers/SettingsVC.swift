...
class SettingsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        guard let user = UserDefaults.standard.string(forKey: "fullName"), !user.isEmpty else {
    ...
    @objc private func logout() {
        ...
        UserDefaults.standard.removeObject(forKey: "givenName")
        UserDefaults.standard.removeObject(forKey: "familyName")
