...
class RootTabBarVC: UITabBarController {
    override func viewDidLoad() {
        ...
        //MARK: Chats Tab Bar
        let chatsListVC = ChatsListVC()
        let chatsListNavVC = UINavigationController(rootViewController: chatsListVC)
        chatsListNavVC.tabBarItem = UITabBarItem(title: "Chats", image: UIImage(systemName: "message"), tag: 0)
        ...
        //MARK: Assign view controllers to the tab bar
        self.viewControllers = [chatsListNavVC, recentCallsNavVC, settingsNavVC]
    }
}
